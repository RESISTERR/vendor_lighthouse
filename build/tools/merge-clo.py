...
"""
Merge script for Project Lighthouse

 The source directory; this is automatically two folder up because the script
 is located in vendor/lighthouse/build/tools. Other ROMs will need to change this. The logic is
 as follows:
